...
export default function CreateStrategy() {
    ...
    const { addStrategy, runSimulation } = useStrategyStore();
    ...
    const handleSaveStrategy = () => {
        ...
        toast.success("Your strategy has been saved as a draft.");
        router.push("/");
    };
    ...
    const handleSubmitSimulation = () => {
        ...
        runSimulation(id);
        toast.success("Your strategy has been submitted for simulation.");
        router.push("/");
    };
    ...
    return (
        <div className="container mx-auto py-8">
            <div className="flex items-center mb-6">
                ...
                <h1 className="text-xl font-medium">Create New Strategy</h1>
            </div>
            ...
            <div className="flex justify-between mt-6">
                <button
                    ...
                    className={`h-8 px-3 flex items-center border border-gray-300 rounded-md bg-white text-gray-700 text-sm font-medium cursor-pointer ${activeTab === "general" ? "opacity-50 cursor-not-allowed" : "hover:bg-gray-100"
                        }`}
                >
                    <ArrowLeft className="h-4 w-4 mr-2" />
                    Previous
